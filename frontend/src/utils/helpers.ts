 ...
 * 根据分数计算掌握程度
 */
export const calculateMasteryLevel = (score: number): 'weak' | 'medium' | 'strong' => {
 ...
 * 生成颜色梯度
 */
export const generateColorGradient = (startColor: string, endColor: string, steps: number): string[] => {
