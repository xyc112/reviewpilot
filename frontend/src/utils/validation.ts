...
export const validateTitle = (title: string, minLength: number = 1, maxLength: number = 100): string | null => {
...
export const validateDescription = (description: string, maxLength: number = 1000): string | null => {
