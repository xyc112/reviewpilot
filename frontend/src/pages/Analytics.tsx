...
import { Card, Row, Col, Statistic, Progress, Typography, Select, DatePicker } from 'antd'
import {
    ClockCircleOutlined,
    RiseOutlined,
    TrophyOutlined,
...
const Analytics: React.FC = () => {
            ...
            series: [
                {
                    ...
                    radius: '50%',
                    data: [
                        { value: stats?.knowledgeMastery.mastered, name: '掌握', itemStyle: { color: MASTERY_LEVELS.strong.color } },
                        { value: stats?.knowledgeMastery.learning, name: '学习中', itemStyle: { color: MASTERY_LEVELS.medium.color } },
                        { value: stats?.knowledgeMastery.weak, name: '薄弱', itemStyle: { color: MASTERY_LEVELS.weak.color } }
                    ],
                    emphasis: {
                        itemStyle: {
                            shadowBlur: 10,
    ...
    return (
        <div css={analyticsStyles.container}>
            ...
            {/* 关键指标 */}
            <Row gutter={[16, 16]} css={[analyticsStyles.section, analyticsStyles.statsGrid]}>
                <Col xs={24} sm={12} lg={6}>
                    <Card css={analyticsStyles.card}>
                        ...
                        />
                        <Text type="secondary">日均 {stats?.studyTime.dailyAverage} 分钟</Text>
                    </Card>
                </Col>
                <Col xs={24} sm={12} lg={6}>
                    <Card css={analyticsStyles.card}>
                ...
                <Col xs={24} sm={12} lg={6}>
                    <Card css={analyticsStyles.card}>
                        ...
                        />
                        <Text type="secondary">
                            {Math.round((stats?.knowledgeMastery.mastered /
                                (stats?.knowledgeMastery.mastered + stats?.knowledgeMastery.learning + stats?.knowledgeMastery.weak)) * 100)}% 已掌握
                        </Text>
                    </Card>
                </Col>
            </Row>
            ...
            <Row gutter={[16, 16]}>
                <Col xs={24}>
                    <Card title="个性化学习建议" css={analyticsStyles.card}>
                        <div style={{ padding: 16, background: '#f6ffed', borderRadius: 6, border: '1px solid #b7eb8f' }}>
