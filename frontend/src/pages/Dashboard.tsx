  ...
  return (
    <div css={dashboardStyles.container}>
      ...
      <Row gutter={[16, 16]}>
        {/* 学习进度 */}
        <Col xs={24} lg={12}>
          <Card title="学习进度" css={dashboardStyles.card}>
            <div css={dashboardStyles.progressSection}>
              ...
              <Row justify="space-between" style={{ marginTop: 8 }}>
                <Text type="secondary">
                  已完成: {learningProgress?.completedPoints}/
                  {learningProgress?.totalPoints}
                </Text>
                <Text type="secondary">
                  掌握: {learningProgress?.masteredPoints}
                </Text>
              </Row>
            </div>
          </Card>
        ...
        {/* 薄弱知识点 */}
        <Col xs={24} lg={12}>
          <Card title="薄弱知识点" css={dashboardStyles.card}>
            <List
