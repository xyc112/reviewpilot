                    ...
                    >
                        <Row gutter={[16, 16]}>
                            <Col xs={12}>
                                ...
                                <br />
                                {diagnosisResult?.improvementAreas.map((area: string, index: number) => (
                            ...
                            <Col xs={12}>
                                ...
                                <div style={{ marginTop: 4 }}>
                                    {diagnosisResult?.priorityOrder.map((item: string, index: number) => (
                                        <Text key={index} type="secondary">
                                            {index + 1}. {item}{index < diagnosisResult.priorityOrder.length - 1 ? ' → ' : ''}
                                        </Text>
                                    ))}
                                </div>
                            </Col>
