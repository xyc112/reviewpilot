...
const QuizSystem: React.FC = () => {
      ...
      const mockQuestions: QuizQuestion[] = [
        {
          ...
          correctAnswer: "B",
          explanation:
            "面向对象编程的核心概念是类和对象，通过封装、继承、多态等特性实现代码的模块化和复用。",
          difficulty: "EASY",
          pointId: 1,
        },
        {
  ...
  const getOptionStyle = (questionId: number, option: string) => {
    ...
    const isCorrect = option.startsWith(
      questions.find((q) => q.questionId === questionId)?.correctAnswer || "",
    );
          ...
          <Col xs={24} lg={12}>
            <Card css={quizStyles.card}>
              <div css={quizStyles.resultSection}>
                ...
                <Title
                  level={3}
                  style={{ color: score >= 60 ? "#52c41a" : "#ff4d4f" }}
                >
                  {score} 分
                </Title>
                <Progress
        ...
        <Card
          ...
          title={
            <div>
              ...
              <Tag
                color={
                  DIFFICULTY_LEVELS[questions[currentQuestion].difficulty].color
                }
                style={{ marginLeft: 8 }}
              >
